...
public class libreriaAudio {
	...
	File SonidoIni = new File("/Catman_fred/src/audio/intro.wav"); // creamos el object file
    ...
    //  y cuando el Ratón va comiendo los quesitos
 	File SonidoBott = new File("/Catman_fred/src/audio/atepellot.wav"); // creamos el object file
    ...
    // Reproducimos el sonido cuando muere el Ratón 
  	File SonidoDied = new File("/Catman_fred/src/audio/died.wav"); // creamos el object file
 	String sSonidoDied = "file:///"+ SonidoDied.getAbsolutePath(); // capturamos la ruta del ejecutable
      ...
      // Reproducimos el sonido cuando el Raton se come el super queso
    	File SonidoSQ = new File("/Catman_fred/src/audio/ateghost.wav"); // creamos el object file
   	String sSonidoSQ = "file:///"+ SonidoSQ.getAbsolutePath(); // capturamos la ruta del ejecutable
    	...
    	File SonidoCatBlue = new File("/Catman_fred/src/audio/ateghost.wav"); // creamos el object file
